                ...
                {signupType === 'user' && (
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="input-field pl-9 pr-2 text-sm py-2.5 w-full"
                                        required
                                    />
                                    <button
                                        type="button"
                            ...
                            <div>
                                <label className="block text-gray-300 text-xs font-medium mb-1.5">Confirm</label>
                                <div className="relative">
                                    <LockIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-lg" />
                                    <input
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <div className="relative">
                                    <PersonIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-lg" />
                                    <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Your name" className="input-field pl-9 text-sm py-2.5 w-full" required />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    <EmailIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-lg" />
                                    <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Your email" className="input-field pl-9 text-sm py-2.5 w-full" required />
                                </div>
                            </div>
                            <div>
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" name="companyName" value={formData.companyName} onChange={handleChange} placeholder="Your rooftop name" className="input-field pl-9 text-sm py-2.5 w-full" required />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" name="location" value={formData.location} onChange={handleChange} placeholder="e.g., Karachi, Pakistan" className="input-field pl-9 text-sm py-2.5 w-full" required />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="time" name="openTime" value={formData.openTime} onChange={handleChange} className="input-field text-sm py-2.5 w-full" />
                            </div>
                            <div>
                                <label className="block text-gray-300 text-xs font-medium mb-1.5">Closing</label>
                                <input type="time" name="closeTime" value={formData.closeTime} onChange={handleChange} className="input-field text-sm py-2.5 w-full" />
                            </div>
                            <div>
                ...
                {signupType === 'admin' && step === 3 && (
                    <>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <LockIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-lg" />
                                <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} placeholder="Confirm password" className="input-field pl-9 text-sm py-2.5 w-full" required />
                            </div>
                        </div>
